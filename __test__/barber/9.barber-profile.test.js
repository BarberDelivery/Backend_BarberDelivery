...
describe("GET /barber/barber-profile", () => {
  it("should response barber and response 201", async () => {
    const response = await request(app).get("/barber/barber-profile").set("access_token", access_token);
  ...
  it("should response and status 401", async () => {
    const response = await request(app).patch("/barber/barber-profile");
